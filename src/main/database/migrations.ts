...
export const MIGRATIONS: readonly Migration[] = [
  {
    ...
    sql: `
      ...
      CREATE TABLE IF NOT EXISTS payroll_records (
        id INTEGER PRIMARY KEY, batch_id INTEGER NOT NULL REFERENCES payroll_batches(id) ON DELETE CASCADE, line_number INTEGER NOT NULL,
        component TEXT, funding_source TEXT, employee_number TEXT, employee_name TEXT, position_name TEXT,
        movement_type TEXT, movement_classifier TEXT, concept_code TEXT, concept_description_original TEXT,
        concept_description_normalized TEXT, concept_description_canonical TEXT, concept_variant TEXT, account_code TEXT,
        amount_cents INTEGER, control_code TEXT, final_indicator TEXT, status TEXT NOT NULL, concept_rule_id INTEGER,
        exclusion_rule_id INTEGER, exclusion_category TEXT, exclusion_reason TEXT, validation_error TEXT, raw_line TEXT, created_at TEXT NOT NULL
      );
      ...
      CREATE INDEX IF NOT EXISTS idx_records_status ON payroll_records(batch_id, status);
      CREATE INDEX IF NOT EXISTS idx_records_concept ON payroll_records(batch_id, concept_code);
      CREATE INDEX IF NOT EXISTS idx_records_account ON payroll_records(batch_id, account_code);
      CREATE INDEX IF NOT EXISTS idx_records_employee ON payroll_records(employee_number);
