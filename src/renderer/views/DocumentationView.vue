...
<template>
  ...
  <div class="documentation-layout"><nav class="documentation-index" aria-label="Temas de documentación"><a href="#reconocimiento">Reconocimiento</a><a href="#operaciones">Suma y resta</a><a href="#retenidos">Retenidos</a><a href="#duplicados">Duplicados</a><a href="#reportes">Reportes</a><a href="#conceptos">Conceptos vigentes</a></nav>
