...
import { UNIFORM_PAYROLL_LAYOUT, mapUniformColumns } from '../../src/shared/payroll-layouts/uniformPayrollLayout.js';
...
describe('layout uniforme', () => {
  it('centraliza las 22 posiciones y mapea la muestra', () => {
    const columns = '21111|06|1|06|3457|M007C0200000|99999|04001|1508-26-001|26|4|NOMBRE|PUESTO|800|D|2|101|I S R POR SALARIOS|790.20|CUENTA|CO|1'.split('|');
    const mapped = mapUniformColumns(columns);
    expect(UNIFORM_PAYROLL_LAYOUT.expectedColumns).toBe(22);
    expect(mapped).toMatchObject({ employeeNumber: '3457', employeeName: 'NOMBRE', movementType: 'D', conceptCode: '101', amountRaw: '790.20' });
  });
