...
describe('layout uniforme', () => {
  it('documenta las 22 columnas operativas del TXT en su orden original', () => {
    ...
    expect(UNIFORM_PAYROLL_COLUMNS[4]?.header).toBe('Número de empleado');
  ...
  it('centraliza las 22 posiciones y mapea la muestra', () => {
    ...
    expect(mapped).toMatchObject({ dependencyKey: '21111061-06', sourceKey: '1508-26-001', employeeNumber: '3457', employeeName: 'NOMBRE',
